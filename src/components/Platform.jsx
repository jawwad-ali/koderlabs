...
const Platform = () => {
  ...
  return (
    <div className="w-full mb-20">
      ...
      {/* Platform Section */}
      <div className="w-full bg-[#f7f7f7] md:mt-24 mt-12 border-box md:justify-around">
        <div
          className="flex justify-between lg:max-w-6xl md:max-w-[44rem] overflow-hidden mx-auto"
          data-aos="fade-right"
          duration="400"
        >
          <div
            className="flex w-full flex-col justify-center items-center h-[18rem] md:py-10 py-5 md:px-5 hover:bg-[#391F5B] hover:text-white cursor-pointer"
            onMouseOver={() => setWebDiv(true)}
            onMouseOut={() => setWebDiv(false)}
          >
            <img src={Website} alt="website" />
            <span className="md:text-2xl text-sm font-roboto py-2">
              Website
            </span>
            {webDiv && (
          ...
          <div
            className="flex flex-col w-full justify-center items-center h-[18rem] md:py-10 md:px-5 py-5  hover:bg-[#391F5B] hover:text-white cursor-pointer"
            onMouseOver={() => setIOSDiv(true)}
            onMouseOut={() => setIOSDiv(false)}
          >
            <img src={Website} alt="website" />
            <span className="md:text-2xl text-sm font-roboto py-2">IOS</span>
            {IOSDiv && (
              <p className="text-[15px] font-roboto text-white text-center">
          ...
          <div
            className="flex flex-col w-full justify-center items-center md:py-10 md:px-5 h-[18rem] py-5 hover:bg-[#391F5B] hover:text-white cursor-pointer"
          ...
          <div
            className="flex flex-col w-full justify-center items-center md:py-10 py-5 md:px-5 h-[18rem] hover:bg-[#391F5B] hover:text-white cursor-pointer"
            onMouseOver={() => setHybird(true)}
            onMouseOut={() => setHybird(false)}
          >
            <img src={Website} alt="website" />
            <span className="md:text-2xl text-sm font-roboto py-2">Hybird</span>
            {hybird && (
              <p className="text-[15px] font-roboto text-white text-center">
          ...
          <div
            className="flex flex-col w-full justify-center items-center md:py-10 md:px-5 py-5 h-[18rem] hover:bg-[#391F5B] hover:text-white cursor-pointer"
          ...
          >
            <img src={Website} alt="website" />
            <span className="md:text-2xl font-roboto py-2 text-sm">IOT</span>
            {Iot && (
              <p className="text-[15px] font-roboto text-white text-center">
